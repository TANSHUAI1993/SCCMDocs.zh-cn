# [简介](configuration-manager-reference.md)
...
# [替换内容提供程序类](core/servers/configure/alternate-content-provider-classes.md)
...
# [应用程序管理服务器 WMI 类](apps/application-management-server-wmi-classes.md)
...
## [SMS_ApplicationCondition 服务器 WMI 类](apps/sms_applicationcondition-server-wmi-class.md)
...
## [SMS_G_System_AppClientState 服务器 WMI 类](apps/sms_g_system_appclientstate-server-wmi-class.md)
...
# [资产智能服务器 WMI 类](core/clients/asset-intelligence/asset-intelligence-server-wmi-classes.md)
...
# [客户端类](core/clients/client-classes/client-classes.md)
...
### [SMS_InstalledSoftwareMS 客户端 WMI 类](core/clients/client-classes/sms_installedsoftwarems-client-wmi-class.md)
...
#### [类 SMS_Client 中的 SetGlobalLoggingConfiguration 方法](core/clients/client-classes/setgloballoggingconfiguration-method-in-class-sms_client.md)
...
### [ICIINFO 接口](core/clients/client-classes/iciinfo-interface.md)
...
### [CIPackageInfo 结构](core/clients/client-classes/cipackageinfo-structure.md)
...
## [SMS_AntimalwareScanConfig 服务器 WMI 类](core/clients/config/sms_antimalwarescanconfig-server-wmi-class.md)
...
## [SMS_ClientSettingsDefault 服务器 WMI 类](core/clients/config/sms_clientsettingsdefault-server-wmi-class.md)
...
# [客户端部署服务器 WMI 类](core/clients/deploy/client-deployment-server-wmi-classes.md)
...
# [客户端 SDK WMI 类](core/clients/sdk/client-sdk-wmi-classes.md)
...
### [类 CCM_ClientEvents 中的 StoreEvent 方法](core/clients/sdk/storeevent-method-in-class-ccm_clientevents.md)
...
## [CCM_NetworkSettings 客户端 WMI 类](core/clients/sdk/ccm_networksettings-client-wmi-class.md)
...
## [CCM_ServiceWindowManager 客户端 WMI 类](core/clients/sdk/ccm_servicewindowmanager-client-wmi-class.md)
...
### [类 CCM_SoftwareUpdatesManager 中的 PostponeUpdatesToNonBusinessHours 方法](core/clients/sdk/postponeupdatestononbusinesshours-method-in-class-ccm_softwareupdatesmanager.md)
...
### [类 SMS_Collection 中的 ApproveClients 方法](core/clients/collections/approveclients-method-in-class-sms_collection.md)
...
### [类 SMS_Collection 中的 ReassignClientsToSite 方法](core/clients/collections/reassignclientstosite-method-in-class-sms_collection.md)
...
## [SMS_CombinedDeviceResources 服务器 WMI 类](core/clients/collections/sms_combineddeviceresources-server-wmi-class.md)
...
## [SMS_CIRelation_Flat 服务器 WMI 类](compliance/sms_cirelation_flat-server-wmi-class.md)
...
### [类 SMS_ConfigurationPolicyBase 中的 AcceptEULA 方法](compliance/accepteula-method-in-class-sms_configurationpolicybase.md)
...
## [SMS_TermsAndConditionsSettings 服务器 WMI 类](compliance/sms_termsandconditionssettings-server-wmi-class.md)
...
# [内容服务器 WMI 类](core/servers/configure/content-server-wmi-classes.md)
...
## [SMS_DPGroupMembers 服务器 WMI 类](core/servers/configure/sms_dpgroupmembers-server-wmi-class.md)
...
## [SMS_DeviceSettingItem 服务器 WMI 类](mdm/sms_devicesettingitem-server-wmi-class.md)
...
## [SMS_FirewallSettings 服务器 WMI 类](protect/sms_firewallsettings-server-wmi-class.md)
...
#### [类 SMS_MDMCorpOwnedDevices 中的 UpdateProfileIDForDevices 方法](mdm/updateprofileidfordevices-method-in-class-sms_mdmcorpowneddevices.md)
...
## [SMS_MigrationJobEntityRelation 服务器 WMI 类](core/migration/sms_migrationjobentityrelation-server-wmi-class.md)
...
## [SMS_AppUnknownStatePerCollection 服务器 WMI 类](misc/sms_appunknownstatepercollection-server-wmi-class.md)
...
### [类 SMS_SecuredObject 中的 UserHasPermissions 方法](misc/userhaspermissions-method-in-class-sms_securedobject.md)
...
#### [类 SMS_BootImagePackage 中的 AddDistributionPoints 方法](osd/adddistributionpoints-method-in-class-sms_bootimagepackage.md)
...
#### [类 SMS_Driver 中的 CreateFromOEM 方法](osd/createfromoem-method-in-class-sms_driver.md)
...
#### [类 SMS_DriverPackage 中的 AddChangeNotification 方法](osd/addchangenotification-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 AddDistributionPoints 方法](osd/adddistributionpoints-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 AddDriverContent 方法](osd/adddrivercontent-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 CheckSourceFolder 方法](osd/checksourcefolder-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 RebuildPackage 方法](osd/rebuildpackage-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 RefreshPkgSource 方法](osd/refreshpkgsource-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 RemoveDriverContent 方法](osd/removedrivercontent-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 SetSourceSite 方法](osd/setsourcesite-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 Unlock 方法](osd/unlock-method-in-class-sms_driverpackage.md)
#### [类 SMS_DriverPackage 中的 ValidateNewPackageSource 方法](osd/validatenewpackagesource-method-in-class-sms_driverpackage.md)
### [SMS_DriverModel 服务器 WMI 类](osd/sms_drivermodel-server-wmi-class.md)
### [SMS_FailedImageUpdateView 服务器 WMI 类](osd/sms_failedimageupdateview-server-wmi-class.md)
### [SMS_ImageDiskInformation 服务器 WMI 类](osd/sms_imagediskinformation-server-wmi-class.md)
### [SMS_ImageInformation 服务器 WMI 类](osd/sms_imageinformation-server-wmi-class.md)
### [SMS_ImagePackage 服务器 WMI 类](osd/sms_imagepackage-server-wmi-class.md)
#### [类 SMS_ImagePackage 中的 AddChangeNotification 方法](osd/addchangenotification-method-in-class-sms_imagepackage.md)
#### [类 SMS_ImagePackage 中的 AddDistributionPoints 方法](osd/adddistributionpoints-method-in-class-sms_imagepackage.md)
#### [类 SMS_ImagePackage 中的 GetImageProperties 方法](osd/getimageproperties-method-in-class-sms_imagepackage.md)
#### [类 SMS_ImagePackage 中的 RefreshPkgSource 方法](osd/refreshpkgsource-method-in-class-sms_imagepackage.md)
#### [类 SMS_ImagePackage 中的 ReloadImageProperties 方法](osd/reloadimageproperties-method-in-class-sms_imagepackage.md)
#### [类 SMS_ImagePackage 中的 RunOfflineServicingManager 方法](osd/runofflineservicingmanager-method-in-class-sms_imagepackage.md)
#### [类 SMS_ImagePackage 中的 SetSourceSite 方法](osd/setsourcesite-method-in-class-sms_imagepackage.md)
#### [类 SMS_ImagePackage 中的 Unlock 方法](osd/unlock-method-in-class-sms_imagepackage.md)
### [SMS_ImageServicingProgress 服务器 WMI 类](osd/sms_imageservicingprogress-server-wmi-class.md)
### [SMS_ImageServicingSchedule 服务器 WMI 类](osd/sms_imageservicingschedule-server-wmi-class.md)
### [SMS_ImageServicingScanRequest 服务器 WMI 类](osd/sms_imageservicingscanrequest-server-wmi-class.md)
### [SMS_ImageServicingScheduledImage 服务器 WMI 类](osd/sms_imageservicingscheduledimage-server-wmi-class.md)
### [SMS_ImageServicingScheduledUpdate 服务器 WMI 类](osd/sms_imageservicingscheduledupdate-server-wmi-class.md)
### [SMS_ImageUpdateHistory 服务器 WMI 类](osd/sms_imageupdatehistory-server-wmi-class.md)
### [SMS_ImageUpdateStatus 服务器 WMI 类](osd/sms_imageupdatestatus-server-wmi-class.md)
### [SMS_ImageUpdateStatusView 服务器 WMI 类](osd/sms_imageupdatestatusview-server-wmi-class.md)
### [SMS_MachineSettings 服务器 WMI 类](osd/sms_machinesettings-server-wmi-class.md)
### [SMS_MachineVariable 服务器 WMI 类](osd/sms_machinevariable-server-wmi-class.md)
### [SMS_OperatingSystemInstallPackage 服务器 WMI 类](osd/sms_operatingsysteminstallpackage-server-wmi-class.md)
#### [类 SMS_OperatingSystemInstallPackage 中的 AddChangeNotification 方法](osd/addchangenotification-method-in-class-sms_operatingsysteminstallpackage.md)
#### [类 SMS_OperatingSystemInstallPackage 中的 AddDistributionPoints 方法](osd/adddistributionpoints-method-in-class-sms_operatingsysteminstallpackage.md)
#### [类 SMS_OperatingSystemInstallPackage 中的 GetImageProperties 方法](osd/getimageproperties-method-in-class-sms_operatingsysteminstallpackage.md)
#### [类 SMS_OperatingSystemInstallPackage 中的 RefreshPkgSource 方法](osd/refreshpkgsource-method-in-class-sms_operatingsysteminstallpackage.md)
#### [类 SMS_OperatingSystemInstallPackage 中的 ReloadImageProperties 方法](osd/reloadimageproperties-method-in-class-sms_operatingsysteminstallpackage.md)
#### [类 SMS_OperatingSystemInstallPackage 中的 SetSourceSite 方法](osd/setsourcesite-method-in-class-sms_operatingsysteminstallpackage.md)
#### [类 SMS_OperatingSystemInstallPackage 中的 Unlock 方法](osd/unlock-method-in-class-sms_operatingsysteminstallpackage.md)
### [SMS_OSDeploymentConfig 服务器 WMI 类](osd/sms_osdeploymentconfig-server-wmi-class.md)
### [SMS_OSDeploymentKitInstalledVersion 服务器 WMI 类](osd/sms_osdeploymentkitinstalledversion-server-wmi-class.md)
### [SMS_OSDeploymentKitSupportedPlatforms 服务器 WMI 类](osd/sms_osdeploymentkitsupportedplatforms-server-wmi-class.md)
### [SMS_OSDeploymentKitWinPEOptionalComponent 服务器 WMI 类](osd/sms_osdeploymentkitwinpeoptionalcomponent-server-wmi-class.md)
### [SMS_PXECertificateInfo 服务器 WMI 类](osd/sms_pxecertificateinfo-server-wmi-class.md)
### [SMS_StateInformation 服务器 WMI 类](osd/sms_stateinformation-server-wmi-class.md)
### [SMS_StateMigration 服务器 WMI 类](osd/sms_statemigration-server-wmi-class.md)
#### [类 SMS_StateMigration 中的 AddAssociation 方法](osd/addassociation-method-in-class-sms_statemigration.md)
#### [类 SMS_StateMigration 中的 AddAssociationEx 方法](osd/addassociationex-method-in-class-sms_statemigration.md)
#### [类 SMS_StateMigration 中的 DeleteAssociation 方法](osd/deleteassociation-method-in-class-sms_statemigration.md)
#### [类 SMS_StateMigration 中的 GetEncryptDecryptKey 方法](osd/getencryptdecryptkey-method-in-class-sms_statemigration.md)
### [SMS_StateMigrationUserNames 服务器 WMI 类](osd/sms_statemigrationusernames-server-wmi-class.md)
### [SMS_TaskSequence 服务器 WMI 类](osd/sms_tasksequence-server-wmi-class.md)
#### [类 SMS_TaskSequence 中的 ExportXml 方法](osd/exportxml-method-in-class-sms_tasksequence.md)
#### [类 SMS_TaskSequence 中的 LoadFromXml 方法](osd/loadfromxml-method-in-class-sms_tasksequence.md)
#### [类 SMS_TaskSequence 中的 SaveToXml 方法](osd/savetoxml-method-in-class-sms_tasksequence.md)
### [SMS_TaskSequence_Action 服务器 WMI 类](osd/sms_tasksequence_action-server-wmi-class.md)
### [SMS_TaskSequence_ApplicationInfo 服务器 WMI 类](osd/sms_tasksequence_applicationinfo-server-wmi-class.md)
### [SMS_TaskSequence_ApplyDataImageAction 服务器 WMI 类](osd/sms_tasksequence_applydataimageaction-server-wmi-class.md)
### [SMS_TaskSequence_ApplyDriverPackageAction 服务器 WMI 类](osd/sms_tasksequence_applydriverpackageaction-server-wmi-class.md)
### [SMS_TaskSequence_ApplyNetworkSettingsAction 服务器 WMI 类](osd/sms_tasksequence_applynetworksettingsaction-server-wmi-class.md)
### [SMS_TaskSequence_ApplyOperatingSystemAction 服务器 WMI 类](osd/sms_tasksequence_applyoperatingsystemaction-server-wmi-class.md)
### [SMS_TaskSequence_ApplyWindowsSettingsAction 服务器 WMI 类](osd/sms_tasksequence_applywindowssettingsaction-server-wmi-class.md)
### [SMS_TaskSequence_AutoApplyAction 服务器 WMI 类](osd/sms_tasksequence_autoapplyaction-server-wmi-class.md)
### [SMS_TaskSequence_CaptureNetworkSettingsAction 服务器 WMI 类](osd/sms_tasksequence_capturenetworksettingsaction-server-wmi-class.md)
### [SMS_TaskSequence_CaptureSystemImageAction 服务器 WMI 类](osd/sms_tasksequence_capturesystemimageaction-server-wmi-class.md)
### [SMS_TaskSequence_CaptureUserStateAction 服务器 WMI 类](osd/sms_tasksequence_captureuserstateaction-server-wmi-class.md)
### [SMS_TaskSequence_CaptureWindowsSettingsAction 服务器 WMI 类](osd/sms_tasksequence_capturewindowssettingsaction-server-wmi-class.md)
### [SMS_TaskSequence_Condition 服务器 WMI 类](osd/sms_tasksequence_condition-server-wmi-class.md)
### [SMS_TaskSequence_ConditionExpression 服务器 WMI 类](osd/sms_tasksequence_conditionexpression-server-wmi-class.md)
### [SMS_TaskSequence_ConditionOperand 服务器 WMI 类](osd/sms_tasksequence_conditionoperand-server-wmi-class.md)
### [SMS_TaskSequence_ConditionOperator 服务器 WMI 类](osd/sms_tasksequence_conditionoperator-server-wmi-class.md)
### [SMS_TaskSequence_ConnectNetworkFolderAction 服务器 WMI 类](osd/sms_tasksequence_connectnetworkfolderaction-server-wmi-class.md)
### [SMS_TaskSequence_ConvertDiskAction 服务器 WMI 类](osd/sms_tasksequence_convertdiskaction-server-wmi-class.md)
### [SMS_TaskSequence_DisableBitLockerAction 服务器 WMI 类](osd/sms_tasksequence_disablebitlockeraction-server-wmi-class.md)
### [SMS_TaskSequence_DownloadPackageContentAction 服务器 WMI 类](osd/sms_tasksequence_downloadpackagecontentaction-server-wmi-class.md)
### [SMS_TaskSequence_EnableBitLockerAction 服务器 WMI 类](osd/sms_tasksequence_enablebitlockeraction-server-wmi-class.md)
### [SMS_TaskSequence_FileConditionExpression 服务器 WMI 类](osd/sms_tasksequence_fileconditionexpression-server-wmi-class.md)
### [SMS_TaskSequence_FolderConditionExpression 服务器 WMI 类](osd/sms_tasksequence_folderconditionexpression-server-wmi-class.md)
### [SMS_TaskSequence_Group 服务器 WMI 类](osd/sms_tasksequence_group-server-wmi-class.md)
### [SMS_TaskSequence_InstallApplicationAction 服务器 WMI 类](osd/sms_tasksequence_installapplicationaction-server-wmi-class.md)
### [SMS_TaskSequence_InstallDeployToolsAction 服务器 WMI 类](osd/sms_tasksequence_installdeploytoolsaction-server-wmi-class.md)
### [SMS_TaskSequence_InstallSoftwareAction 服务器 WMI 类](osd/sms_tasksequence_installsoftwareaction-server-wmi-class.md)
### [SMS_TaskSequence_InstallUpdateAction 服务器 WMI 类](osd/sms_tasksequence_installupdateaction-server-wmi-class.md)
### [SMS_TaskSequence_JoinDomainWorkgroupAction 服务器 WMI 类](osd/sms_tasksequence_joindomainworkgroupaction-server-wmi-class.md)
### [SMS_TaskSequence_NetworkAdapterSettings 服务器 WMI 类](osd/sms_tasksequence_networkadaptersettings-server-wmi-class.md)
### [SMS_TaskSequence_OfflineEnableBitLockerAction](osd/sms_tasksequence_offlineenablebitlockeraction.md)
### [SMS_TaskSequence_OSConditionGroup 服务器 WMI 类](osd/sms_tasksequence_osconditiongroup-server-wmi-class.md)
### [SMS_TaskSequence_OSExpressionGroup 服务器 WMI 类](osd/sms_tasksequence_osexpressiongroup-server-wmi-class.md)
### [SMS_TaskSequence_PackageInfo 服务器 WMI 类](osd/sms_tasksequence_packageinfo-server-wmi-class.md)
### [SMS_TaskSequence_PartitionDiskAction 服务器 WMI 类](osd/sms_tasksequence_partitiondiskaction-server-wmi-class.md)
### [SMS_TaskSequence_PartitionSettings 服务器 WMI 类](osd/sms_tasksequence_partitionsettings-server-wmi-class.md)
### [SMS_TaskSequence_Pointer 服务器 WMI 类](osd/sms_tasksequence_pointer-server-wmi-class.md)
### [SMS_TaskSequence_PrepareOSAction 服务器 WMI 类](osd/sms_tasksequence_prepareosaction-server-wmi-class.md)
### [SMS_TaskSequence_PrepareSMSClientAction 服务器 WMI 类](osd/sms_tasksequence_preparesmsclientaction-server-wmi-class.md)
### [SMS_TaskSequence_RebootAction 服务器 WMI 类](osd/sms_tasksequence_rebootaction-server-wmi-class.md)
### [SMS_TaskSequence_Reference 服务器 WMI 类](osd/sms_tasksequence_reference-server-wmi-class.md)
### [SMS_TaskSequence_RegistryConditionExpression 服务器 WMI 类](osd/sms_tasksequence_registryconditionexpression-server-wmi-class.md)
### [SMS_TaskSequence_ReleaseStateStoreAction 服务器 WMI 类](osd/sms_tasksequence_releasestatestoreaction-server-wmi-class.md)
### [SMS_TaskSequence_RequestStateStoreAction 服务器 WMI 类](osd/sms_tasksequence_requeststatestoreaction-server-wmi-class.md)
### [SMS_TaskSequence_RestoreUserStateAction 服务器 WMI 类](osd/sms_tasksequence_restoreuserstateaction-server-wmi-class.md)
### [SMS_TaskSequence_RunCommandLineAction 服务器 WMI 类](osd/sms_tasksequence_runcommandlineaction-server-wmi-class.md)
### [SMS_TaskSequence_SetupWindowsAndSMSAction 服务器 WMI 类](osd/sms_tasksequence_setupwindowsandsmsaction-server-wmi-class.md)
### [SMS_TaskSequence_SetVariableAction 服务器 WMI 类](osd/sms_tasksequence_setvariableaction-server-wmi-class.md)
### [SMS_TaskSequence_SoftwareConditionExpression 服务器 WMI 类](osd/sms_tasksequence_softwareconditionexpression-server-wmi-class.md)
### [SMS_TaskSequence_Step 服务器 WMI 类](osd/sms_tasksequence_step-server-wmi-class.md)
### [SMS_TaskSequence_UpgradeOperatingSystemAction 服务器 WMI 类](osd/sms_tasksequence_upgradeoperatingsystemaction-server-wmi-class.md)
### [SMS_TaskSequence_VariableConditionExpression 服务器 WMI 类](osd/sms_tasksequence_variableconditionexpression-server-wmi-class.md)
### [SMS_TaskSequence_WMIConditionExpression 服务器 WMI 类](osd/sms_tasksequence_wmiconditionexpression-server-wmi-class.md)
### [SMS_TaskSequenceAppReferenceDps 服务器 WMI 类](osd/sms_tasksequenceappreferencedps-server-wmi-class.md)
### [SMS_TaskSequenceAppReferencesInfo 服务器 WMI 类](osd/sms_tasksequenceappreferencesinfo-server-wmi-class.md)
### [SMS_TaskSequencePackage 服务器 WMI 类](osd/sms_tasksequencepackage-server-wmi-class.md)
#### [类 SMS_TaskSequencePackage 中的 AddChangeNotification 方法](osd/addchangenotification-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 AddDistributionPoints 方法](osd/adddistributionpoints-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 CheckReferencesShareType 方法](osd/checkreferencessharetype-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetClientConfigPolicies 方法](osd/getclientconfigpolicies-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetContentHash 方法](osd/getcontenthash-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetPackageDefaultHash 方法](osd/getpackagedefaulthash-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetPackageHash 方法](osd/getpackagehash-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetSequence 方法](osd/getsequence-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetTsPolicies 方法](osd/gettspolicies-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetTsPoliciesSaMedia 方法](osd/gettspoliciessamedia-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 GetTSRelatedToDriverCategory 方法](osd/gettsrelatedtodrivercategory-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 ImportSequence 方法](osd/importsequence-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 RefreshPkgSource 方法](osd/refreshpkgsource-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 SetSequence 方法](osd/setsequence-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 SetSourceSite 方法](osd/setsourcesite-method-in-class-sms_tasksequencepackage.md)
#### [类 SMS_TaskSequencePackage 中的 Unlock 方法](osd/unlock-method-in-class-sms_tasksequencepackage.md)
### [SMS_TaskSequencePackageReference 服务器 WMI 类](osd/sms_tasksequencepackagereference-server-wmi-class.md)
### [SMS_TaskSequenceReferenceDps 服务器 WMI 类](osd/sms_tasksequencereferencedps-server-wmi-class.md)
### [SMS_TaskSequenceReferencesInfo 服务器 WMI 类](osd/sms_tasksequencereferencesinfo-server-wmi-class.md)
### [SMS_TaskSequencePackageReference_All 服务器 WMI 类](osd/sms_tasksequencepackagereference_all-server-wmi-class.md)
### [SMS_TaskSequencePackageReference_Flat 服务器 WMI 类](osd/sms_tasksequencepackagereference_flat-server-wmi-class.md)
### [SMS_TaskSequenceExecutionStatus 服务器 WMI 类](osd/sms_tasksequenceexecutionstatus-server-wmi-class.md)
### [SMS_UserSettings 服务器 WMI 类](osd/sms_usersettings-server-wmi-class.md)
### [SMS_UserVariable 服务器 WMI 类](osd/sms_uservariable-server-wmi-class.md)
### [SMS_VhdPackage 服务器 WMI 类](osd/sms_vhdpackage-server-wmi-class.md)
#### [类 SMS_VhdPackage 中的 AddChangeNotification 方法](osd/addchangenotification-method-in-class-sms_vhdpackage.md)
#### [类 SMS_VhdPackage 中的 AddDistributionPoints 方法](osd/adddistributionpoints-method-in-class-sms_vhdpackage.md)
#### [类 SMS_VhdPackage 中的 GetImageProperties 方法](osd/getimageproperties-method-in-class-sms_vhdpackage.md)
#### [类 SMS_VhdPackage 中的 RefreshPkgSource 方法](osd/refreshpkgsource-method-in-class-sms_vhdpackage.md)
#### [类 SMS_VhdPackage 中的 ReloadImageProperties 方法](osd/reloadimageproperties-method-in-class-sms_vhdpackage.md)
#### [类 SMS_VhdPackage 中的 RunOfflineServicingManager 方法](osd/runofflineservicingmanager-method-in-class-sms_vhdpackage.md)
#### [类 SMS_VhdPackage 中的 SetSourceSite 方法](osd/setsourcesite-method-in-class-sms_vhdpackage.md)
#### [类 SMS_VhdPackage 中的 Unlock 方法](osd/unlock-method-in-class-sms_vhdpackage.md)
### [SMS_WinPEOptionalComponentInBootImage 服务器 WMI 类](osd/sms_winpeoptionalcomponentinbootimage-server-wmi-class.md)
### [SMS_WinPEOptionalComponentInfo 服务器 WMI 类](osd/sms_winpeoptionalcomponentinfo-server-wmi-class.md)
### [Operating System Deployment CreateMedia.exe](osd/operating-system-deployment-createmedia.exe.md)

# [带外管理服务器 WMI 类](misc/out-of-band-management-server-wmi-classes.md)
## [SMS_AMTCertificate 服务器 WMI 类](misc/sms_amtcertificate-server-wmi-class.md)
## [SMS_AMTMachineInfo 服务器 WMI 类](misc/sms_amtmachineinfo-server-wmi-class.md)

# [报表服务器 WMI 类](core/servers/reporting/configuration-manager-reporting-server-wmi-classes.md)
## [SMS_ReportViewSchema 服务器 WMI 类](core/servers/reporting/sms_reportviewschema-server-wmi-class.md)
### [类 SMS_ReportViewSchema 中的 GetSampleValues 方法](core/servers/reporting/getsamplevalues-method-in-class-sms_reportviewschema.md)

# [资源管理服务器 WMI 类](core/clients/manage/configuration-manager-resource-management-server-wmi-classes.md)
## [硬件清单服务器 WMI 类](core/clients/manage/hardware-inventory-server-wmi-classes.md)
### [SMS_G_System_SYSTEM 服务器 WMI 类](core/clients/manage/sms_g_system_system-server-wmi-class.md)
### [SMS_G_Sysetm_WORKSTATION_STATUS 服务器 WMI 类](core/clients/manage/sms_g_system_workstation_status-server-wmi-class.md)
### [SMS_InventoryClass 服务器 WMI 类](core/clients/manage/sms_inventoryclass-server-wmi-class.md)
### [SMS_InventoryClassProperty 服务器 WMI 类](core/clients/manage/sms_inventoryclassproperty-server-wmi-class.md)
### [SMS_InventoryReport 服务器 WMI 类](core/clients/manage/sms_inventoryreport-server-wmi-class.md)
#### [类 SMS_InventoryReport 中的 ImportInventoryReport 方法](core/clients/manage/importinventoryreport-method-in-class-sms_inventoryreport.md)
### [SMSInventoryReportClass 服务器 WMI 类](core/clients/manage/sms_inventoryreportclass-server-wmi-class.md)
## [SMS_G_System 服务器 WMI 类](core/clients/manage/sms_g_system-server-wmi-class.md)
## [SMS_G_System_AdvancedThreatProtectionHealthStatus 服务器 WMI 类](core/clients/manage/sms_g_system_advancedthreatprotectionhealthstatus-server-wmi-class.md)
## [SMS_G_System_CollectedFile 服务器 WMI 类](core/clients/manage/sms_g_system_collectedfile-server-wmi-class.md)
## [SMS_G_System_Current 服务器 WMI 类](core/clients/manage/sms_g_system_current-server-wmi-class.md)
## [SMS_G_System_ExHistory 服务器 WMI 类](core/clients/manage/sms_g_system_exthistory-server-wmi-class.md)
## [SMS_G_System_History 服务器 WMI 类](core/clients/manage/sms_g_system_history-server-wmi-class.md)
## [SMS_G_System_LastSoftwareScan 服务器 WMI 类](core/clients/manage/sms_g_system_lastsoftwarescan-server-wmi-class.md)
## [SMS_G_SYSTEM_ResourceClientSettingsAssignment 服务器 WMI 类](core/clients/manage/sms_g_system_resourceclientsettingsassignment-server-wmi-class.md)
## [SMS_G_System_SoftwareFile 服务器 WMI 类](core/clients/manage/sms_g_system_softwarefile-server-wmi-class.md)
## [SMS_G_System_SoftwareProduct 服务器 WMI 类](core/clients/manage/sms_g_system_softwareproduct-server-wmi-class.md)
## [SMS_G_System_UnknownFile 服务器 WMI 类](core/clients/manage/sms_g_system_unknownfile-server-wmi-class.md)
## [SMS_Group 服务器 WMI 类](core/clients/manage/sms_group-server-wmi-class.md)
## [SMS_PendingRegistrationRecord 服务器 WMI 类](core/clients/manage/sms_pendingregistrationrecord-server-wmi-class.md)
### [类 SMS_PendingRegistrationRecord 中的 ResolvePendingRegistrationRecord 方法](core/clients/manage/resolvependingregistrationrecord-method-in-class-sms_pendingregistrationrecord.md)
## [SMS_Query 服务器 WMI 类](core/clients/manage/sms_query-server-wmi-class.md)
### [类 SMS_Query 中的 CreateCCRs 方法](core/clients/manage/createccrs-method-in-class-sms_query.md)
### [类 SMS_Query 中的 FindResourceSite 方法](core/clients/manage/findresourcesite-method-in-class-sms_query.md)
## [SMS_R_IPNetwork 服务器 WMI 类](core/clients/manage/sms_r_ipnetwork-server-wmi-class.md)
## [SMS_R_System 服务器 WMI 类](core/clients/manage/sms_r_system-server-wmi-class.md)
## [SMS_R_User 服务器 WMI 类](core/clients/manage/sms_r_user-server-wmi-class.md)
## [SMS_R_UserGroup 服务器 WMI 类](core/clients/manage/sms_r_usergroup-server-wmi-class.md)
## [SMS_ResIDValueLookup 服务器 WMI 类](core/clients/manage/sms_residvaluelookup-server-wmi-class.md)
## [SMS_Resource 服务器 WMI 类](core/clients/manage/sms_resource-server-wmi-class.md)
## [SMS_ResourceMap 服务器 WMI 类](core/clients/manage/sms_resourcemap-server-wmi-class.md)
### [类 SMS_ResourceMap 中的 GetClassesWithData 方法](core/clients/manage/getclasseswithdata-method-in-class-sms_resourcemap.md)
### [类 SMS_ResourceMap 中的 Refresh 方法](core/clients/manage/refresh-method-in-class-sms_resourcemap.md)
## [SMS_SoftwareConversionRules 服务器 WMI 类](core/clients/manage/sms_softwareconversionrules-server-wmi-class.md)
## [SMS_UserMachineRelationship 服务器 WMI 类](core/clients/manage/sms_usermachinerelationship-server-wmi-class.md)
### [类 SMS_UserMachineRelationship 中的 AddSource 方法](core/clients/manage/addsource-method-in-class-sms_usermachinerelationship.md)
### [类 SMS_UserMachineRelationship 中的 AddType 方法](core/clients/manage/addtype-method-in-class-sms_usermachinerelationship.md)
### [类 SMS_UserMachineRelationship 中的 CreateRelationship 方法](core/clients/manage/createrelationship-method-in-class-sms_usermachinerelationship.md)
### [类 SMS_UserMachineRelationship 中的 RemoveSource 方法](core/clients/manage/removesource-method-in-class-sms_usermachinerelationship.md)
### [类 SMS_UserMachineRelationship 中的 RemoveType 方法](core/clients/manage/removetype-method-in-class-sms_usermachinerelationship.md)

# [基于角色的管理服务器 WMI 类](core/servers/configure/role-based-administration-server-wmi-classes.md)
## [SMS_Admin 服务器 WMI 类](core/servers/configure/sms_admin-server-wmi-class.md)
### [类 SMS_Admin 中的 GetAdminExtendedData 方法](core/servers/configure/getadminextendeddata-method-in-class-sms_admin.md)
## [SMS_AdminCategory 服务器 WMI 类](core/servers/configure/sms_admincategory-server-wmi-class.md)
## [SMS_AdminRole 服务器 WMI 类](core/servers/configure/sms_adminrole-server-wmi-class.md)
## [SMS_APermission 服务器 WMI 类](core/servers/configure/sms_apermission-server-wmi-class.md)
## [SMS_ARoleOperation 服务器 WMI 类](core/servers/configure/sms_aroleoperation-server-wmi-class.md)
## [SMS_AssociatedSecuredCategory 服务器 WMI 类](core/servers/configure/sms_associatedsecuredcategory-server-wmi-class.md)
## [SMS_InitSettableSecuredCategory 服务器 WMI 类](core/servers/configure/sms_initsettablesecuredcategory-server-wmi-class.md)
## [SMS_LastCategoryObject 服务器 WMI 类](core/servers/configure/sms_lastcategoryobject-server-wmi-class.md)
## [SMS_Operation 服务器 WMI 类](core/servers/configure/sms_operation-server-wmi-class.md)
## [SMS_Permission 服务器 WMI 类](core/servers/configure/sms_permission-server-wmi-class.md)
## [SMS_RbacSecuredObject 服务器 WMI 类](core/servers/configure/sms_rbacsecuredobject-server-wmi-class.md)
### [类 SMS_RbacSecuredObject 中的 GetAvailableScopes 方法](core/servers/configure/getavailablescopes-method-in-class-sms_rbacsecuredobject.md)
### [类 SMS_RbacSecuredObject 中的 GetCollectionsWithResourcePermissions 方法](core/servers/configure/getcollectionswithresourcepermissions-method-in-class-sms_rbacsecuredobject.md)
### [类 SMS_RbacSecuredObject 中的 GetUserList 方法](core/servers/configure/getuserlist-method-in-class-sms_rbacsecuredobject.md)
### [类 SMS_RbacSecuredObject 中的 UserHasPermissions 方法](core/servers/configure/userhaspermissions-method-in-class-sms_rbacsecuredobject.md)
## [SMS_Role 服务器 WMI 类](core/servers/configure/sms_role-server-wmi-class.md)
### [类 SMS_Role 中的 ExportRole 方法](core/servers/configure/exportrole-method-in-class-sms_role.md)
### [类 SMS_Role 中的 ImportRole 方法](core/servers/configure/importrole-method-in-class-sms_role.md)
## [SMS_SecuredCategory 服务器 WMI 类](core/servers/configure/sms_securedcategory-server-wmi-class.md)
## [SMS_SecuredCategoryMembership 服务器 WMI 类](core/servers/configure/sms_securedcategorymembership-server-wmi-class.md)
### [类 SMS_SecuredCategoryMembership 中的 AddMemberships 方法](core/servers/configure/addmemberships-method-in-class-sms_securedcategorymembership.md)
### [类 SMS_SecuredCategoryMembership 中的 RemoveMemberships 方法](core/servers/configure/removememberships-method-in-class-sms_securedcategorymembership.md)
## [SMS_SettableSecuredCategory 服务器 WMI 类](core/servers/configure/sms_settablesecuredcategory-server-wmi-class.md)

# [计划服务器 WMI 类](core/servers/configure/scheduling-server-wmi-classes.md)
## [SMS_ScheduleMethods 服务器 WMI 类](core/servers/configure/sms_schedulemethods-server-wmi-class.md)
### [类 SMS_ScheduleMethods 中的 ReadFromString 方法](core/servers/configure/readfromstring-method-in-class-sms_schedulemethods.md)
### [类 SMS_ScheduleMethods 中的 WriteToString 方法](core/servers/configure/writetostring-method-in-class-sms_schedulemethods.md)
## [SMS_ScheduleToken 服务器 WMI 类](core/servers/configure/sms_scheduletoken-server-wmi-class.md)
## [SMS_ST_NonRecurring 服务器 WMI 类](core/servers/configure/sms_st_nonrecurring-server-wmi-class.md)
## [SMS_ST_RecurInterval 服务器 WMI 类](core/servers/configure/sms_st_recurinterval-server-wmi-class.md)
## [SMS_ST_RecurMonthlyByDate 服务器 WMI 类](core/servers/configure/sms_st_recurmonthlybydate-server-wmi-class.md)
## [SMS_ST_RecurMonthlyByWeekday 服务器 WMI 类](core/servers/configure/sms_st_recurmonthlybyweekday-server-wmi-class.md)
## [SMS_ST_RecurWeekly 服务器 WMI 类](core/servers/configure/sms_st_recurweekly-server-wmi-class.md)

# [SEDO 服务器 WMI 类](misc/sedo-server-wmi-classes.md)
## [SMS_ObjectLock 服务器 WMI 类](misc/sms_objectlock-server-wmi-class.md)
### [类 SMS_ObjectLock 中的 CancelLockRequest 方法](misc/cancellockrequest-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 CancelLockRequests 方法](misc/cancellockrequests-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 CheckLockRequest 方法](misc/checklockrequest-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 CheckLockRequests 方法](misc/checklockrequests-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 GetLockInformation 方法](misc/getlockinformation-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 ReleaseAllLocks 方法](misc/releasealllocks-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 ReleaseLock 方法](misc/releaselock-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 ReleaseLocks 方法](misc/releaselocks-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 RequestLock 方法](misc/requestlock-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 RequestLockAsync 方法](misc/requestlockasync-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 RequestLocks 方法](misc/requestlocks-method-in-class-sms_objectlock.md)
### [类 SMS_ObjectLock 中的 RequestLocksAsync 方法](misc/requestlocksasync-method-in-class-sms_objectlock.md)
## [SMS_ObjectLockRequest 服务器 WMI 类](misc/sms_objectlockrequest-server-wmi-class.md)

# [站点配置服务器 WMI 类](core/servers/configure/site-configuration-server-wmi-classes.md)
## [SMS_Boundary 服务器 WMI 类](core/servers/configure/sms_boundary-server-wmi-class.md)
## [SMS_BoundaryGroup 服务器 WMI 类](core/servers/configure/sms_boundarygroup-server-wmi-class.md)
### [类 SMS_BoundaryGroup 中的 AddBoundary 方法](core/servers/configure/addboundary-method-in-class-sms_boundarygroup.md)
### [类 SMS_BoundaryGroup 中的 AddSiteSystem 方法](core/servers/configure/addsitesystem-method-in-class-sms_boundarygroup.md)
### [类 SMS_BoundaryGroup 中的 RemoveBoundary 方法](core/servers/configure/removeboundary-method-in-class-sms_boundarygroup.md)
### [类 SMS_BoundaryGroup 中的 RemoveSiteSystem 方法](core/servers/configure/removesitesystem-method-in-class-sms_boundarygroup.md)
## [SMS_BoundaryGroupMembers 服务器 WMI 类](core/servers/configure/sms_boundarygroupmembers-server-wmi-class.md)
## [SMS_BoundaryGroupRelationships 服务器 WMI 类](core/servers/configure/sms-boundarygrouprelationships-server-wmi-class.md)
### [类 SMS_BoundaryGroupRelationships 中的 FallbackDP 方法](core/servers/configure/fallbackdp-method-in-class-sms-boundarygrouprelationships.md)
### [类 SMS_BoundaryGroupRelationships 中的 FallbackMP 方法](core/servers/configure/fallbackmp-method-in-class-sms-boundarygrouprelationships.md)
### [类 SMS_BoundaryGroupRelationships 中的 FallbackSMP 方法](core/servers/configure/fallbacksmp-method-in-class-sms-boundarygrouprelationships.md)
### [类 SMS_BoundaryGroupRelationships 中的 FallbackSUP 方法](core/servers/configure/fallbacksup-method-in-class-sms-boundarygrouprelationships.md)
## [SMS_BoundaryGroupSiteSystems 服务器 WMI 类](core/servers/configure/sms_boundarygroupsitesystems-server-wmi-class.md)
## [SMS_Client_Reg_MultiString_List 服务器 WMI 类](core/servers/configure/sms_client_reg_multistring_list-server-wmi-class.md)
## [SMS_CMSiteConfiguration 服务器 WMI 类](core/servers/configure/sms_cmsiteconfiguration-server-wmi-class.md)
## [SMS_DefaultBoundaryGroup 服务器 WMI 类](core/servers/configure/sms-defaultboundarygroup-server-wmi-class.md)
### [类 SMS_DefaultBoundaryGroup 中的 AddBoundary 方法](core/servers/configure/addboundary-method-in-class-sms-defaultboundarygroup.md)
### [类 SMS_DefaultBoundaryGroup 中的 AddSiteSystem 方法](core/servers/configure/addsitesystem-method-in-class-sms-defaultboundarygroup.md)
### [类 SMS_DefaultBoundaryGroup 中的 RemoveBoundary 方法](core/servers/configure/removeboundary-method-in-class-sms-defaultboundarygroup.md)
### [类 SMS_DefaultBoundaryGroup 中的 RemoveSiteSystem 方法](core/servers/configure/removesitesystem-method-in-class-sms-defaultboundarygroup.md)
## [SMS_EmbeddedProperty 服务器 WMI 类](core/servers/configure/sms_embeddedproperty-server-wmi-class.md)
## [SMS_EmbeddedPropertyList 服务器 WMI 类](core/servers/configure/sms_embeddedpropertylist-server-wmi-class.md)
## [SMS_Identification 服务器 WMI 类](core/servers/configure/sms_identification-server-wmi-class.md)
### [类 SMS_Identification 中的 GetCurrentUser 方法](core/servers/configure/getcurrentuser-method-in-class-sms_identification.md)
### [类 SMS_Identification 中的 GetFileBinary 方法](core/servers/configure/getfilebinary-method-in-class-sms_identification.md)
### [类 SMS_Identification 中的 GetProviderVersion 方法](core/servers/configure/getproviderversion-method-in-class-sms_identification.md)
### [类 SMS_Identification 中的 GetSiteID 方法](core/servers/configure/getsiteid-method-in-class-sms_identification.md)
## [SMS_RcmSqlControl 服务器 WMI 类](core/servers/configure/sms_rcmsqlcontrol-server-wmi-class.md)
## [SMS_RcmSqlControlProperty 服务器 WMI 类](core/servers/configure/sms_rcmsqlcontrolproperty-server-wmi-class.md)
## [SMS_ReplicationGroup 服务器 WMI 类](core/servers/configure/sms_replicationgroup-server-wmi-class.md)
### [类 SMS_ReplicationGroup 中的 InitializeData 方法](core/servers/configure/initializedata-method-in-class-sms_replicationgroup.md)
## [SMS_ReplicationLinkStatus 服务器 WMI 类](core/servers/configure/sms_replicationlinkstatus-server-wmi-class.md)
## [SMS_ReplicationLinkSummary 服务器 WMI 类](core/servers/configure/sms_replicationlinksummary-server-wmi-class.md)
## [SMS_SCI_Address 服务器 WMI 类](core/servers/configure/sms_sci_address-server-wmi-class.md)
## [SMS_SCI_ClientComp 服务器 WMI 类](core/servers/configure/sms_sci_clientcomp-server-wmi-class.md)
## [SMS_SCI_ClientConfig 服务器 WMI 类](core/servers/configure/sms_sci_clientconfig-server-wmi-class.md)
## [SMS_SCI_Component 服务器 WMI 类](core/servers/configure/sms_sci_component-server-wmi-class.md)
## [SMS_SCI_Configuration 服务器 WMI 类](core/servers/configure/sms_sci_configuration-server-wmi-class.md)
## [SMS_SCI_FileDefinition 服务器 WMI 类](core/servers/configure/sms_sci_filedefinition-server-wmi-class.md)
## [SMS_SCI_MaintenanceTask 服务器 WMI 类](core/servers/configure/sms_sci_maintenancetask-server-wmi-class.md)
## [SMS_SCI_SiteDefinition 服务器 WMI 类](core/servers/configure/sms_sci_sitedefinition-server-wmi-class.md)
## [SMS_SCI_SQLTask 服务器 WMI 类](core/servers/configure/sms_sci_sqltask-server-wmi-class.md)
## [SMS_SCI_SysResUse 服务器 WMI 类](core/servers/configure/sms_sci_sysresuse-server-wmi-class.md)
## [SMS_SII_Property 服务器 WMI 类](core/servers/configure/sms_sii_property-server-wmi-class.md)
## [SMS_SII_PropertyList 服务器 WMI 类](core/servers/configure/sms_sii_propertylist-server-wmi-class.md)
## [SMS_SIIB_AddressType 服务器 WMI 类](core/servers/configure/sms_siib_addresstype-server-wmi-class.md)
## [SMS_SIIB_Component_FileList 服务器 WMI 类](core/servers/configure/sms_siib_component_filelist-server-wmi-class.md)
## [SMS_SIIB_Configuration 服务器 WMI 类](core/servers/configure/sms_siib_configuration-server-wmi-class.md)
## [SMS_SIIB_Generic_Configuration 服务器 WMI 类](core/servers/configure/sms_siib_generic_configuration-server-wmi-class.md)
## [SMS_SIIB_SenderType 服务器 WMI 类](core/servers/configure/sms_siib_sendertype-server-wmi-class.md)
## [SMS_SIIB_SysResRole 服务器 WMI 类](core/servers/configure/sms_siib_sysresrole-server-wmi-class.md)
## [SMS_Site 服务器 WMI 类](core/servers/configure/sms_site-server-wmi-class.md)
### [类 SMS_Site 中的 EncryptDataEx 方法](core/servers/configure/encryptdataex-method-in-class-sms_site.md)
### [类 SMS_Site 中的 GetAutoUpgradeConfigs 方法](core/servers/configure/getautoupgradeconfigs-method-in-class-sms_site.md)
### [类 SMS_Site 中的 GetClientInfo 方法](core/servers/configure/getclientinfo-method-in-class-sms_site.md)
### [类 SMS_Site 中的 GetClientPilotingConfigs 方法](core/servers/configure/getclientpilotingconfigs-method-in-class-sms_site.md)
### [类 SMS_Site 中的 GetFeatureState 方法](core/servers/configure/getfeaturestate-method-in-class-sms_site.md)
### [类 SMS_Site 中的 GetSiteADInfo 方法](core/servers/configure/getsiteadinfo-method-in-class-sms_site.md)
### [类 SMS_Site 中的 ImportGlobalUserAccount 方法](core/servers/configure/importglobaluseraccount-method-in-class-sms_site.md)
### [类 SMS_Site 中的 ImportGlobalUserAccountEx 方法](core/servers/configure/importglobaluseraccountex-method-in-class-sms_site.md)
### [类 SMS_Site 中的 ImportMachineEntry 方法](core/servers/configure/importmachineentry-method-in-class-sms_site.md)
### [类 SMS_Site 中的 IsUsedCert 方法](core/servers/configure/isusedcert-method-in-class-sms_site.md)
### [类 SMS_Site 中的 RedistributeAutoUpgradeClientContent 方法](core/servers/configure/redistributeautoupgradeclientcontent-method-in-class-sms_site.md)
### [类 SMS_Site 中的 SubmitAMTCert 方法](core/servers/configure/submitamtcert-method-in-class-sms_site.md)
### [类 SMS_Site 中的 SubmitRegistrationRecord 方法](core/servers/configure/submitregistrationrecord-method-in-class-sms_site.md)
### [类 SMS_Site 中的 UpdateAutoUpgradeClientContent 方法](core/servers/configure/updateautoupgradeclientcontent-method-in-class-sms_site.md)
### [类 SMS_Site 中的 UpdateAutoUpgradeConfigs 方法](core/servers/configure/updateautoupgradeconfigs-method-in-class-sms_site.md)
### [类 SMS_Site 中的 UpdateClientPilotingConfigs 方法](core/servers/configure/updateclientpilotingconfigs-method-in-class-sms_site.md)
### [类 SMS_Site 中的 UpdateConsoleUsageData 方法](core/servers/configure/updateconsoleusagedata-method-in-class-sms_site.md)
### [类 SMS_Site 中的 UpdateFeatureState 方法](core/servers/configure/updatefeaturestate-method-in-class-sms_site.md)
### [类 SMS_Site 中的 VerifyNoLoops 方法](core/servers/configure/verifynoloops-method-in-class-sms_site.md)
## [SMS_SiteAndSubsites 服务器 WMI 类](core/servers/configure/sms_siteandsubsites-server-wmi-class.md)
## [SMS_SiteControlDaySchedule 服务器 WMI 类](core/servers/configure/sms_sitecontroldayschedule-server-wmi-class.md)
## [SMS_SiteControlFile 服务器 WMI 类](core/servers/configure/sms_sitecontrolfile-server-wmi-class.md)
## [SMS_SiteControlItem 服务器 WMI 类](core/servers/configure/sms_sitecontrolitem-server-wmi-class.md)
## [SMS_SiteInstallItem 服务器 WMI 类](core/servers/configure/sms_siteinstallitem-server-wmi-class.md)
## [SMS_SiteInstallItemBase 服务器 WMI 类](core/servers/configure/sms_siteinstallitembase-server-wmi-class.md)
## [SMS_SiteInstallMap 服务器 WMI 类](core/servers/configure/sms_siteinstallmap-server-wmi-class.md)
### [类 SMS_SiteInstallMap 中的 Refresh 方法](core/servers/configure/refresh-method-in-class-sms_siteinstallmap.md)
## [SMS_SystemResourceList 服务器 WMI 类](core/servers/configure/sms_systemresourcelist-server-wmi-class.md)
## [SMS_SCFToSCI_a 服务器 WMI 类](core/servers/configure/sms_scftosci_a-server-wmi-class.md)
## [SMS_SCFToSite_a 服务器 WMI 类](core/servers/configure/sms_scftosite_a-server-wmi-class.md)
## [SMS_SiteToSubSite_a 服务器 WMI 类](core/servers/configure/sms_sitetosubsite_a-server-wmi-class.md)
## [SMS_SiteToSiteID_a 服务器 WMI 类](core/servers/configure/sms_sitetositeid_a-server-wmi-class.md)

# [软件分发服务器 WMI 类](core/servers/configure/software-distribution-server-wmi-classes.md)
## [SMS_Advertisement 服务器 WMI 类](core/servers/configure/sms_advertisement-server-wmi-class.md)
### [类 SMS_Advertisement 中的 GetAdvertisements 方法](core/servers/configure/getadvertisements-method-in-class-sms_advertisement.md)
### [类 SMS_Advertisement 中的 GetNextID 方法](core/servers/configure/getnextid-method-in-class-sms_advertisement.md)
### [类 SMS_Advertisement 中的 RiskyDeploymentStatusMessage 方法](core/servers/configure/riskydeploymentstatusmessage-method-in-class-sms_advertisement.md)
### [类 SMS_Advertisement 中的 SetNextID 方法](core/servers/configure/setnextid-method-in-class-sms_advertisement.md)
### [类 SMS_Advertisement 中的 SetSourceSite 方法](core/servers/configure/setsourcesite-method-in-class-sms_advertisement.md)
### [类 SMS_Advertisement 中的 Unlock 方法](core/servers/configure/unlock-method-in-class-sms_advertisement.md)
## [SMS_AdvertisementInfo 服务器 WMI 类](core/servers/configure/sms_advertisementinfo-server-wmi-class.md)
## [SMS_AdvertisementStatusInformation 服务器 WMI 类](core/servers/configure/sms_advertisementstatusinformation-server-wmi-class.md)
## [SMS_AdvertToSourceSite_a 服务器 WMI 类](core/servers/configure/sms_adverttosourcesite_a-server-wmi-class.md)
## [SMS_ClassicDeploymentAssetDetails 服务器 WMI 类](core/servers/configure/sms_classicdeploymentassetdetails-server-wmi-class.md)
## [SMS_ClassicDeploymentStatus 服务器 WMI 类](core/servers/configure/sms_classicdeploymentstatus-server-wmi-class.md)
## [SMS_ClientAdvertisementStatus 服务器 WMI 类](core/servers/configure/sms_clientadvertisementstatus-server-wmi-class.md)
## [SMS_ClientAdvertisementSummary 服务器 WMI 类](core/servers/configure/sms_clientadvertisementsummary-server-wmi-class.md)
## [SMS_DistributionDPStatus 服务器 WMI 类](core/servers/configure/sms_distributiondpstatus-server-wmi-class.md)
## [SMS_DistributionJob 服务器 WMI 类](core/servers/configure/sms_distributionjob-server-wmi-class.md)
## [SMS_DistributionPoint 服务器 WMI 类](core/servers/configure/sms_distributionpoint-server-wmi-class.md)
### [类 SMS_DistributionPoint 中的 VerifyPackage 方法](core/servers/configure/verifypackage-method-in-class-sms_distributionpoint.md)
### [类 SMS_DistributionPoint 中的 CancelDistribution 方法](core/servers/configure/canceldistribution-method-in-class-sms_distributionpoint.md)
## [SMS_DistributionPointDriveInfo 服务器 WMI 类](core/servers/configure/sms_distributionpointdriveinfo-server-wmi-class.md)
## [SMS_DistributionPointGroup 服务器 WMI 类](core/servers/configure/sms_distributionpointgroup-server-wmi-class.md)
### [类 SMS_DistributionPointGroup 中的 AddDistributionPoints 方法](core/servers/configure/adddistributionpoints-method-in-class-sms_distributionpointgroup.md)
### [类 SMS_DistributionPointGroup 中的 AddPackages 方法](core/servers/configure/addpackages-method-in-class-sms_distributionpointgroup.md)
### [类 SMS_DistributionPointGroup 中的 AssociateCollections 方法](core/servers/configure/associatecollections-method-in-class-sms_distributionpointgroup.md)
### [类 SMS_DistributionPointGroup 中的 DisassociateCollections 方法](core/servers/configure/disassociatecollections-method-in-class-sms_distributionpointgroup.md)
### [类 SMS_DistributionPointGroup 中的 ReDistributePackage 方法](core/servers/configure/redistributepackage-method-in-class-sms_distributionpointgroup.md)
### [类 SMS_DistributionPointGroup 中的 RefreshDPGroup 方法](core/servers/configure/refreshdpgroup-method-in-class-sms_distributionpointgroup.md)
### [类 SMS_DistributionPointGroup 中的 RemoveDistributionPoints 方法](core/servers/configure/removedistributionpoints-method-in-class-sms_distributionpointgroup.md)
### [类 SMS_DistributionPointGroup 中的 RemovePackages 方法](core/servers/configure/removepackages-method-in-class-sms_distributionpointgroup.md)
## [SMS_DistributionPointInfo 服务器 WMI 类](core/servers/configure/sms_distributionpointinfo-server-wmi-class.md)
### [类 SMSDistributionPointInfo 中的 GetChainedPullDPs 方法](core/servers/configure/getchainedpulldps-method-in-class-smsdistributionpointinfo.md)
## [SMS_DistributionStatus 服务器 WMI 类](core/servers/configure/sms_distributionstatus-server-wmi-class.md)
## [SMS_LastPXEAdvertisement 服务器 WMI 类](core/servers/configure/sms_lastpxeadvertisement-server-wmi-class.md)
## [SMS_OS_Details 服务器 WMI 类](core/servers/configure/sms_os_details-server-wmi-class.md)
## [SMS_Package 服务器 WMI 类](core/servers/configure/sms_package-server-wmi-class.md)
### [类 SMS_Package 中的 AddChangeNotification 方法](core/servers/configure/addchangenotification-method-in-class-sms_package.md)
### [类 SMS_Package 中的 AddDistributionPoints 方法](core/servers/configure/adddistributionpoints-method-in-class-sms_package.md)
### [类 SMS_Package 中的 CheckDuplicateShareName 方法](core/servers/configure/checkduplicatesharename-method-in-class-sms_package.md)
### [类 SMS_Package 中的 CheckDuplicateSourceName 方法](core/servers/configure/checkduplicatesourcename-method-in-class-sms_package.md)
### [类 SMS_Package 中的CheckPackageShareForTaskSequenceDeployment 方法](core/servers/configure/checkpackagesharefortasksequencedeployment-method-in-class-sms_package.md)
### [类 SMS_Package 中的 RefreshPkgSource 方法](core/servers/configure/refreshpkgsource-method-in-class-sms_package.md)
### [类 SMS_Package 中的 SetSourceSite 方法](core/servers/configure/setsourcesite-method-in-class-sms_package.md)
### [类 SMS_Package 中的 Unlock 方法](core/servers/configure/unlock-method-in-class-sms_package.md)
## [SMS_PackageAccessByUsers 服务器 WMI 类](core/servers/configure/sms_packageaccessbyusers-server-wmi-class.md)
## [SMS_PackageBaseclass 服务器 WMI 类](core/servers/configure/sms_packagebaseclass-server-wmi-class.md)
## [SMS_PackageStatus 服务器 WMI 类](core/servers/configure/sms_packagestatus-server-wmi-class.md)
## [SMS_PackageStatusDetailSummarizer 服务器 WMI 类](core/servers/configure/sms_packagestatusdetailsummarizer-server-wmi-class.md)
## [SMS_PackageStatusDistPointsSummarizer 服务器 WMI 类](core/servers/configure/sms_packagestatusdistpointssummarizer-server-wmi-class.md)
## [SMS_PackageStatusRootSummarizer 服务器 WMI 类](core/servers/configure/sms_packagestatusrootsummarizer-server-wmi-class.md)
## [SMS_PackageToAdvert_a 服务器 WMI 类](core/servers/configure/sms_packagetoadvert_a-server-wmi-class.md)
## [SMS_PackageToContent 服务器 WMI 类](core/servers/configure/sms_packagetocontent-server-wmi-class.md)
### [类 SMS_PackageToContent 中的 IsContentValid 方法](core/servers/configure/iscontentvalid-method-in-class-sms_packagetocontent.md)
## [SMS_PackageToSourceSite_a 服务器 WMI 类](core/servers/configure/sms_packagetosourcesite_a-server-wmi-class.md)
## [SMS_PDF_Package 服务器 WMI 类](core/servers/configure/sms_pdf_package-server-wmi-class.md)
### [类 SMS_PDF_Package 中的 GetPDFData 方法](core/servers/configure/getpdfdata-method-in-class-sms_pdf_package.md)
### [类 SMS_PDF_Package 中的 LoadIconForPDF 方法](core/servers/configure/loadiconforpdf-method-in-class-sms_pdf_package.md)
### [类 SMS_PDF_Package 中的 LoadPDF 方法](core/servers/configure/loadpdf-method-in-class-sms_pdf_package.md)
### [类 SMS_PDF_Package 中的 ProcessInBox 方法](core/servers/configure/processinbox-method-in-class-sms_pdf_package.md)
## [SMS_PDF_Program 服务器 WMI 类](core/servers/configure/sms_pdf_program-server-wmi-class.md)
## [SMS_PDFPkgToPDFProgram_a 服务器 WMI 类](core/servers/configure/sms_pdfpkgtopdfprogram_a-server-wmi-class.md)
## [SMS_PkgToPkgAccess_a 服务器 WMI 类](core/servers/configure/sms_pkgtopkgaccess_a-server-wmi-class.md)
## [SMS_PkgToPkgProgram_a 服务器 WMI 类](core/servers/configure/sms_pkgtopkgprogram_a-server-wmi-class.md)
## [SMS_PkgToPkgServer_a 服务器 WMI 类](core/servers/configure/sms_pkgtopkgserver_a-server-wmi-class.md)
## [SMS_Program 服务器 WMI 类](core/servers/configure/sms_program-server-wmi-class.md)
## [SMS_ServiceWindow 服务器 WMI 类](core/servers/configure/sms_servicewindow-server-wmi-class.md)
## [SMS_SupportedPlatforms 服务器 WMI 类](core/servers/configure/sms_supportedplatforms-server-wmi-class.md)
### [类 SMS_SupportedPlatforms 中的 Enable 方法](core/servers/configure/enable-method-in-class-sms_supportedplatforms.md)
## [SMS_SupportedPlatformsOfflineServicing 服务器 WMI 类](core/servers/configure/sms_supportedplatformsofflineservicing-server-wmi-class.md)

# [软件计数服务器 WMI 类](apps/software-metering-server-wmi-classes.md)
## [SMS_FileUsageSummary 服务器 WMI 类](apps/sms_fileusagesummary-server-wmi-class.md)
## [SMS_G_System_SoftwareUsageData 服务器 WMI 类](apps/sms_g_system_softwareusagedata-server-wmi-class.md)
## [SMS_MeterData 服务器 WMI 类](apps/sms_meterdata-server-wmi-class.md)
## [SMS_MeteredFiles 服务器 WMI 类](apps/sms_meteredfiles-server-wmi-class.md)
## [SMS_MeteredProductRule 服务器 WMI 类](apps/sms_meteredproductrule-server-wmi-class.md)
## [SMS_MeteredUser 服务器 WMI 类](apps/sms_metereduser-server-wmi-class.md)
## [SMS_MonthlyUsageSummary 服务器 WMI 类](apps/sms_monthlyusagesummary-server-wmi-class.md)
## [SMS_ProductFileInfo 服务器 WMI 类](apps/sms_productfileinfo-server-wmi-class.md)
## [SMS_SummarizationInterval 服务器 WMI 类](apps/sms_summarizationinterval-server-wmi-class.md)

# [软件更新服务器 WMI 类](sum/software-updates-server-wmi-classes.md)
## [SMS_ADRDeploymentSettings 服务器 WMI 类](sum/sms_adrdeploymentsettings-server-wmi-class.md)
## [SMS_AutoDeployment 服务器 WMI 类](sum/sms_autodeployment-server-wmi-class.md)
### [类 SMS_AutoDeployment 中的 EvaluateAllAutoDeployment 方法](sum/evaluateallautodeployment-method-in-class-sms_autodeployment.md)
### [类 SMS_AutoDeployment 中的 EvaluateAutoDeployment 方法](sum/evaluateautodeployment-method-in-class-sms_autodeployment.md)
## [SMS_AuthorizationList 服务器 WMI 类](sum/sms_authorizationlist-server-wmi-class.md)
### [类 SMS_AuthorizationList 中的 RunAuthListStatusSummarization 方法](sum/runauthliststatussummarization-method-in-class-sms_authorizationlist.md)
## [SMS_CIAllCategories 服务器 WMI 类](sum/sms_ciallcategories-server-wmi-class.md)
## [SMS_CIContentFiles 服务器 WMI 类](sum/sms_cicontentfiles-server-wmi-class.md)
## [SMS_CIRelation 服务器 WMI 类](sum/sms_cirelation-server-wmi-class.md)
## [SMS_CIToContent 服务器 WMI 类](sum/sms_citocontent-server-wmi-class.md)
## [SMS_CIUpdateSources 服务器 WMI 类](sum/sms_ciupdatesources-server-wmi-class.md)
## [SMS_CM_UpdateFeatures 服务器 WMI 类](sum/sms_cm_updatefeatures-server-wmi-class.md)
### [类 SMS_CM_UpdateFeatures 中的 UpdateFeatureExposureStatus 方法](sum/updatefeatureexposurestatus-method-in-class-sms_cm_updatefeatures.md)
## [SMS_CM_UpdatePackageFeatures 服务器 WMI 类](sum/sms_cm_updatepackagefeatures-server-wmi-class.md)
### [类 SMS_CM_UpdatePackageFeatures 中的 UpdateFeatureExposureStatus 方法](sum/updatefeatureexposurestatus-method-in-class-sms_cm_updatepackagefeatures.md)
## [SMS_CM_UpdatePackages 服务器 WMI 类](sum/sms_cm_updatepackages-server-wmi-class.md)
### [类 SMS_CM_UpdatePackages 中的 IsCurrentWorkingUpdatePackage 方法](sum/iscurrentworkingupdatepackage-method-in-class-sms_cm_updatepackages.md)
### [类 SMS_CM_UpdatePackages 中的 RetryContentReplication 方法](sum/retrycontentreplication-method-in-class-sms_cm_updatepackages.md)
### [类 SMS_CM_UpdatePackages 中的 SetIgnorePrereqWarning 方法](sum/setignoreprereqwarning-method-in-class-sms_cm_updatepackages.md)
### [类 SMS_CM_UpdatePackages 中的 UpdatePrereqAndStateFlags 方法](sum/updateprereqandstateflags-method-in-class-sms_cm_updatepackages.md)
## [SMS_CM_UpdatePackagesHistory 服务器 WMI 类](sum/sms_cm_updatepackageshistory-server-wmi-class.md)
## [SMS_CM_UpdatePackageSiteStatus 服务器 WMI 类](sum/sms_cm_updatepackagesitestatus-server-wmi-class.md)
### [类 SMS_CM_UpdatePackageSiteStatus 中的 UpdatePackageSiteState 方法](sum/updatepackagesitestate-method-in-class-sms_cm_updatepackagesitestatus.md)
## [SMS_CM_UpdatePackDetailedMonitoring 服务器 WMI 类](sum/sms_cm_updatepackdetailedmonitoring-server-wmi-class.md)
## [SMS_CM_UpdatePackDetailedPrereqMonitoring 服务器 WMI 类](sum/sms_cm_updatepackdetailedprereqmonitoring-server-wmi-class.md)
## [SMS_CM_UpdatePackDetailedSiteStatus 服务器 WMI 类](sum/sms_cm_updatepackdetailedsitestatus-server-wmi-class.md)
## [SMS_CM_UpdatePackDownloadMonitoring 服务器 WMI 类](sum/sms_cm_updatepackdownloadmonitoring-server-wmi-class.md)
## [SMS_CM_UpdatePackTopLevelMonitoring 服务器 WMI 类](sum/sms_cm_updatepacktoplevelmonitoring-server-wmi-class.md)
## [SMS_EULAContent 服务器 WMI 类](sum/sms_eulacontent-server-wmi-class.md)
## [SMS_FeatureExtension 服务器 WMI 类](sum/sms_featureextension-server-wmi-class.md)
## [SMS_ServicePlan 服务器 WMI 类](sum/sms_serviceplan-server-wmi-class.md)
## [SMS_SoftwareUpdate 服务器 WMI 类](sum/sms_softwareupdate-server-wmi-class.md)
### [类 SMS_SoftwareUpdate 中的 AcceptEULA 方法](sum/accepteula-method-in-class-sms_softwareupdate.md)
### [类 SMS_SoftwareUpdate 中的 GetEULA 方法](sum/geteula-method-in-class-sms_softwareupdate.md)
### [类 SMS_SoftwareUpdate 中的 SetEnforcement 方法](sum/setenforcement-method-in-class-sms_softwareupdate.md)
### [类 SMS_SoftwareUpdate 中的 SyncNow 方法](sum/syncnow-method-in-class-sms_softwareupdate.md)
## [SMS_SoftwareUpdateBase 服务器 WMI 类](sum/sms_softwareupdatebase-server-wmi-class.md)
## [SMS_SoftwareUpdateSource 服务器 WMI 类](sum/sms_softwareupdatesource-server-wmi-class.md)
## [SMS_SoftwareUpdatesPackage 服务器 WMI 类](sum/sms_softwareupdatespackage-server-wmi-class.md)
### [类 SMS_SoftwareUpdatesPackage 中的 AddChangeNotification 方法](sum/addchangenotification-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 AddDistributionPoints 方法](sum/adddistributionpoints-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 AddUpdateContent 方法](sum/addupdatecontent-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 RebuildPackage 方法](sum/rebuildpackage-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 RefreshPkgSource 方法](sum/refreshpkgsource-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 RemoveContent 方法](sum/removecontent-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 SetSourceSite 方法](sum/setsourcesite-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 Unlock 方法](sum/unlock-method-in-class-sms_softwareupdatespackage.md)
### [类 SMS_SoftwareUpdatesPackage 中的 ValidateNewPackageSource 方法](sum/validatenewpackagesource-method-in-class-sms_softwareupdatespackage.md)
## [SMS_SUMDeploymentAssetDetails 服务器 WMI 类](sum/sms_sumdeploymentassetdetails-server-wmi-class.md)
## [SMS_SUMDeploymentStatistics 服务器 WMI 类](sum/sms_sumdeploymentstatistics-server-wmi-class.md)
## [SMS_SUMDeploymentStatus 服务器 WMI 类](sum/sms_sumdeploymentstatus-server-wmi-class.md)
## [SMS_SUPSyncStatus 服务器 WMI 类](sum/sms_supsyncstatus-server-wmi-class.md)
## [SMS_Template 服务器 WMI 类](sum/sms_template-server-wmi-class.md)
## [SMS_UpdateCategoryInstance 服务器 WMI 类](sum/sms_updatecategoryinstance-server-wmi-class.md)
## [SMS_UpdateComplianceStatus 服务器 WMI 类](sum/sms_updatecompliancestatus-server-wmi-class.md)
## [SMS_UpdateDeploymentSummary 服务器 WMI 类](sum/sms_updatedeploymentsummary-server-wmi-class.md)
## [SMS_UpdateGroupAssignment 服务器 WMI 类](sum/sms_updategroupassignment-server-wmi-class.md)
## [SMS_UpdatesAssignment 服务器 WMI 类](sum/sms_updatesassignment-server-wmi-class.md)

# [支持服务器 WMI 类](misc/supporting-server-wmi-classes.md)
## [SMS_ContextMethods 服务器 WMI 类](misc/sms_contextmethods-server-wmi-class.md)
### [类 SMS_ContextMethods 中的 ClearContextHandle 方法](misc/clearcontexthandle-method-in-class-sms_contextmethods.md)
### [类 SMS_ContextMethods 中的 GetContextHandle 方法](misc/getcontexthandle-method-in-class-sms_contextmethods.md)
## [SMS_ExtendedStatus 服务器 WMI 类](misc/sms_extendedstatus-server-wmi-class.md)
## [SMS_NAL_Methods 服务器 WMI 类](misc/sms_nal_methods-server-wmi-class.md)
### [类 SMS_NAL_Methods 中的 PackNALPath 方法](misc/packnalpath-method-in-class-sms_nal_methods.md)
### [类 SMS_NAL_Methods 中的 UnPackNALPath 方法](misc/unpacknalpath-method-in-class-sms_nal_methods.md)
## [SMS_ProviderLocation 服务器 WMI 类](misc/sms_providerlocation-server-wmi-class.md)

# [状态类](core/servers/manage/status-classes.md)
## [状态客户端 API](core/servers/manage/status-client-apis.md)
### [Smscstat.dll 状态消息函数](core/servers/manage/smscstat.dll-status-message-functions.md)
#### [AddAttributeToSMSStatusMessage 函数](core/servers/manage/addattributetosmsstatusmessage-function.md)
#### [CreateSMSStatusMessage 函数](core/servers/manage/createsmsstatusmessage-function.md)
#### [ReportSMSStatusMessage 函数](core/servers/manage/reportsmsstatusmessage-function.md)
### [SMSEvent 类](core/servers/manage/smsevent-class.md)
#### [ICCMEvent::EventType 属性](core/servers/manage/iccmevent--eventtype-property.md)
#### [ICCMEvent::RawEvent 属性](core/servers/manage/iccmevent--rawevent-property.md)
...
## [状态消息类型](core/servers/manage/status-message-types.md)
...
## [状态 MIF 函数](core/servers/manage/status-mif-functions.md)
### [Create 函数](core/servers/manage/create-function.md)
### [InstallStatusMIF 函数](core/servers/manage/installstatusmif-function.md)
### [InstallStatusMIFEx 函数](core/servers/manage/installstatusmifex-function.md)
## [状态服务器 API](core/servers/manage/status-server-api.md)
### [SMSFormatMessageCtl 类](core/servers/manage/smsformatmessagectl-class.md)
...
## [状态服务器 WMI 类](core/servers/manage/status-server-wmi-classes.md)
### [SMS_ComponentSummarizer 服务器 WMI 类](core/servers/manage/sms_componentsummarizer-server-wmi-class.md)
#### [类 SMS_ComponentSummarizer 中的 DeleteStatistics 方法](core/servers/manage/deletestatistics-method-in-class-sms_componentsummarizer.md)
### [SMS_SecondarySiteStatus 服务器 WMI 类](core/servers/manage/sms_secondarysitestatus-server-wmi-class.md)
### [SMS_SiteDetailSummarizer 服务器 WMI 类](core/servers/manage/sms_sitedetailsummarizer-server-wmi-class.md)
### [SMS_SiteSystemSummarizer 服务器 WMI 类](core/servers/manage/sms_sitesystemsummarizer-server-wmi-class.md)
### [SMS_StatAttr 服务器 WMI 类](core/servers/manage/sms_statattr-server-wmi-class.md)
### [SMS_StatInsStr 服务器 WMI 类](core/servers/manage/sms_statinsstr-server-wmi-class.md)
### [SMS_StatMsg 服务器 WMI 类](core/servers/manage/sms_statmsg-server-wmi-class.md)
### [SMS_StatMsgAttributes 服务器 WMI 类](core/servers/manage/sms_statmsgattributes-server-wmi-class.md)
### [SMS_StatMsgInsStrings 服务器 WMI 类](core/servers/manage/sms_statmsginsstrings-server-wmi-class.md)
### [SMS_StatMsgModuleNames 服务器 WMI 类](core/servers/manage/sms_statmsgmodulenames-server-wmi-class.md)
### [SMS_StatMsgWithInsStrings 服务器 WMI 类](core/servers/manage/sms_statmsgwithinsstrings-server-wmi-class.md)
### [SMS_StatusMessage 服务器 WMI 类](core/servers/manage/sms_statusmessage-server-wmi-class.md)
#### [类 SMS_StatusMessage 中的 DeleteByID 方法](core/servers/manage/deletebyid-method-in-class-sms_statusmessage.md)
#### [类 SMS_StatusMessage 中的 DeleteByQuery 方法](core/servers/manage/deletebyquery-method-in-class-sms_statusmessage.md)
#### [类 SMS_StatusMessage 中的 RaiseErrorStatusMsg 方法](core/servers/manage/raiseerrorstatusmsg-method-in-class-sms_statusmessage.md)
#### [类 SMS_StatusMessage 中的 RaiseInformationalStatusMsg 方法](core/servers/manage/raiseinformationalstatusmsg-method-in-class-sms_statusmessage.md)
#### [类 SMS_StatusMessage 中的 RaiseRawStatusMsg 方法](core/servers/manage/raiserawstatusmsg-method-in-class-sms_statusmessage.md)
#### [类 SMS_StatusMessage 中的 RaiseWarningStatusMsg 方法](core/servers/manage/raisewarningstatusmsg-method-in-class-sms_statusmessage.md)
### [SMS_SummarizerRootStatus 服务器 WMI 类](core/servers/manage/sms_summarizerrootstatus-server-wmi-class.md)
#### [类 SMS_SummarizerRootStatus 中的 GetTallyIntervals 方法](core/servers/manage/gettallyintervals-method-in-class-sms_summarizerrootstatus.md)
### [SMS_SummarizationSettings 服务器 WMI 类](core/servers/manage/sms_summarizationsettings-server-wmi-class.md)
#### [类 SMS_SummarizationSettings 中的 GetSummarizationSettings 方法](core/servers/manage/getsummarizationsettings-method-in-class-sms_summarizationsettings.md)
#### [类 SMS_SummarizationSettings 中的 SetSummarizationSettings 方法](core/servers/manage/setsummarizationsettings-method-in-class-sms_summarizationsettings.md)
### [SMS_SummarizerSiteStatus 服务器 WMI 类](core/servers/manage/sms_summarizersitestatus-server-wmi-class.md)
### [SMS_SummarizerStatus 服务器 WMI 类](core/servers/manage/sms_summarizerstatus-server-wmi-class.md)

# [Windows Azure 服务器 WMI 类](core/servers/configure/windows-azure-server-wmi-classes.md)
## [SMS_AzureService 服务器 WMI 类](core/servers/configure/sms_azureservice-server-wmi-class.md)
### [类 SMS_AzureService 中的 Start 方法](core/servers/configure/start-method-in-class-sms_azureservice.md)
### [类 SMS_AzureService 中的 Stop 方法](core/servers/configure/stop-method-in-class-sms_azureservice.md)
## [SMS_AzureServicesTask 服务器 WMI 类](core/servers/configure/sms_azureservicestask-server-wmi-class.md)

# [Windows 10 维护服务服务器 WMI 类](misc/windows-10-servicing-server-wmi-classes.md)
## [SMS_AdminUIContent 服务器 WMI 类](misc/sms-adminuicontent-server-wmi-class.md)
## [SMS_Windows10Dashboard 服务器 WMI 类](misc/sms_windows10dashboard-server-wmi-class.md)
## [SMS_WindowsServicingBusinessReadyUpdates 服务器 WMI 类](misc/sms_windowsservicingbusinessreadyupdates-server-wmi-class.md)
## [SMS_WindowsServicingLocalizedNames 服务器 WMI 类](misc/sms_windowsservicinglocalizednames-server-wmi-class.md)
## [SMS_WindowsServicingStates 服务器 WMI 类](misc/sms_windowsservicingstates-server-wmi-class.md)

# [Configuration Manager 托管参考](https://msdn.microsoft.com/library/mt767606.aspx)

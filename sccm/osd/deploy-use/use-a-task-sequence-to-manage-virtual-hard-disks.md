...
5.  在“任务序列信息”  页上，指定以下设置，然后单击“下一步” 。  
    ...
    -   **启动映像**：指定用于在目标计算机上安装操作系统的启动映像。 有关详细信息，请参阅[管理启动映像](../get-started/manage-boot-images.md)。  
...
6.  在“安装 Windows”  页上，指定以下设置，然后单击“下一步” 。  
    ...
    -   指定如何处理在部署操作系统映像时使用的管理员帐户。  
        ...
        -   **随机生成本地管理员密码并在所有支持的平台上禁用帐户(推荐)**：使用此设置让向导为本地管理员帐户随机创建一个密码，并在部署了操作系统映像后禁用该帐户。  
...
6.  在“设置计划”  页上，指定以下设置，然后单击“下一步” 。  
    ...
    2.  **出错时继续**：选择此选项以便即使在出错时也将软件更新应用于映像。  

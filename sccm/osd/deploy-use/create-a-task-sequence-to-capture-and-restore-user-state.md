---
title: "创建用于捕获和还原用户状态的任务序列 | Configuration Manager"
...
##  <a name="a-namebkmkcapturerestoreuserstatea-how-to-capture-and-restore-user-state-data"></a><a name="BKMK_CaptureRestoreUserState"></a> 如何捕获和还原用户状态数据  

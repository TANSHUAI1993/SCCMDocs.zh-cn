...
|他配置集合的以下警报： <br /><br />1) **检测到恶意软件**：John 将警报严重性配置为**严重**。 <br /><br />2) **在多台计算机上检测到相同类型的恶意软件**：米申将警报的严重性配置为“严重”并指定当 5% 以上的计算机检测到恶意软件时将生成警报。 <br /><br />3) **在指定时间间隔内，在计算机上重复检测到相同类型的恶意软件**：米申将警报的严重性配置为“严重”并指定当在 24 小时内检测到恶意软件的次数超过 5 次时将生成警报。 <br /><br />4) **在指定的时间间隔内，同一台计算机上检测到多种恶意软件**：米申将警报的严重性配置为“严重”并指定当 24 小时内检测到 3 种以上的恶意软件时将生成警报。<br /><br /> “警报严重性”的值指示将在 Configuration Manager 控制台和电子邮件中接收的警报中显示的警报级别。<br /><br /> 此外，他选择“在 Endpoint Protection 仪表板中查看此集合”选项，以便可在 Configuration Manager 控制台中监视警报。|请参阅[在 System Center Configuration Manager 中配置 Endpoint Protection](endpoint-configure-alerts.md) 中的“为 Endpoint Protection 配置警报”。|  

...
本主题通过提供示例方案，说明了如何在 Configuration Manager 中实施 Endpoint Protection 以保护组织中的计算机免遭恶意软件攻击。  
 ...
 John 是 Woodgrove Bank 的 Configuration Manager 管理员。 该银行目前使用 Microsoft Forefront Endpoint Protection 2010 来保护计算机免受恶意软件攻击。 此外，该银行使用 Windows 组策略来确保公司中的所有计算机上都启用了 Windows 防火墙，并确保在 Windows 防火墙阻止新程序时通知用户。  

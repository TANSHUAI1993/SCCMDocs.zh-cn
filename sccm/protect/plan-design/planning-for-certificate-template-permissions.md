...
2.  如果帐户由于域控制器无响应而无法进行验证，并且你要绕过权限检查：  
    ...
    -   在承载证书注册点的站点系统服务器上，创建下列 DWORD 注册表项以具有值 0：1:hkey_local_machine\software\microsoft\sccm\crp\skiptemplatecheckonlyifaccountaccessdenied  

...
---
# <a name="create-configuration-items-for-windows-81-and-windows-10-devices-managed-with-intune"></a>为使用 Intune 管理的 Windows 8.1 和 Windows 10 设备创建配置项
...
8.  在“设备设置”页面上，选择要配置的设置组。 请参阅本主题中的 [Windows 8.1 和 Windows 10 配置项目设置参考](#windows-81-and-windows-10-configuration-item-settings-reference) 以了解详细信息，然后单击“下一步” 。  

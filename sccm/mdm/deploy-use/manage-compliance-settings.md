...
### <a name="scenario-restrict-access-to-the-app-store-on-all-windows-pcs"></a>方案：限制对所有 Windows Pc 上的 app store 的访问  
...
### <a name="scenario-disable-the-use-of-screen-capture-on-a-windows-phone"></a>方案：禁用 Windows Phone 上屏幕捕获  
...
### <a name="scenario-require-a-password-on-all-android-5-devices"></a>方案：所有 Android 5 设备上需要密码  

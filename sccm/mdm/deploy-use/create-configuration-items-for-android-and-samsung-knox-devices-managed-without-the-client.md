...
---
# <a name="create-configuration-items-for-android-and-samsung-knox-standard-devices-managed-with-intune"></a>为使用 Intune 管理的 Android 和 Samsung KNOX 标准版设备创建配置项
...
8.  在“设备设置”页面上，选择要配置的设置组。 请参阅本主题中的 [Android 和 Samsung KNOX 标准版配置项目设置参考](#android-and-samsung-knox-standard-configuration-item-settings-reference)，了解详细信息，然后单击“下一步”。  

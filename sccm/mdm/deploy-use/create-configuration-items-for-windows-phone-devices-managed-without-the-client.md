...
|**添加**|将应用添加到选定的列表。 在应用商店中指定你选择的名称（可选择使用应用发布者）和应用的 URL。<br /><br /> 若要从 Windows Phone 商店页面指定 URL，请搜索想要使用的应用。<br /><br /> **示例：** 在应用商店中搜索**Skype**应用。 你使用的 URL 将为 https://www.windowsphone.com/en-us/store/app/skype/c3f8e570-68b3-4d6a-bdbb-c0a3f4360a51 。<br /><br /> 对于公司门户应用或业务线应用，无需指定完整的 URL，指定应用 GUID 即可。|  

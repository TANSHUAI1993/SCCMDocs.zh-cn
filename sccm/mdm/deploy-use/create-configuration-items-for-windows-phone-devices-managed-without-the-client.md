...
---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>如何为使用 Intune 管理的 Windows Phone 设备创建配置项
...
8.  在“设备设置”页面上，选择要配置的设置组。 请参阅本主题中的 [Windows Phone 配置项目设置参考](#windows-phone-configuration-item-settings-reference)以了解详细信息，然后单击“下一步”。  

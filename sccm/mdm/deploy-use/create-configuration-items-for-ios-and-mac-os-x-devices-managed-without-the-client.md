...
---
# <a name="create-configuration-items-for-ios-and-mac-os-x-devices-managed-with-intune"></a>为使用 Intune 管理的 iOS 和 Mac OS X 设备创建配置项
...
8.  在“设备设置”页面上，选择要配置的设置组。 请参阅本主题中的 [iOS 和 Mac OS X 配置项目设置参考](#ios-and-mac-os-x-configuration-item-settings-reference) 以了解详细信息，然后单击“下一步” 。  

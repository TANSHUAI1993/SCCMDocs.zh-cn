...
- 必须将[移动设备管理 (MDM) 机构](https://docs.microsoft.com/sccm/mdm/deploy-use/change-mdm-authority)设置为 Intune。  
...
混合 Azure AD 设置后，Configuration Manager 客户端配置就绪，并向用户分配了产品许可证，现在可以切换开关并启用 Windows 10 设备的共同管理。  

...
- [过滤任务序列变量中存储的敏感数据](https://configurationmanager.uservoice.com/forums/300492-ideas/suggestions/15282795-secret-task-sequence-variable-value-exposed)：在[设置任务序列变量](/sccm/osd/understand/task-sequence-steps#BKMK_SetTaskSequenceVariable)步骤中，选择新选项“不显示此值”  。 例如，指定密码时。<!--1358330--> 当启用此选项时，以下行为适用：
  - 变量值不显示在 smsts.log 中。

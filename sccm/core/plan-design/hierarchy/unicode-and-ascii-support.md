---
title: "Unicode 和 ASCII 支持 | System Center Configuration Manager"
...
##  <a name="a-namebkmkasciichara-objects-that-use-ascii-characters"></a><a name="BKMK_ASCIIchar"></a>使用 ASCII 字符的对象  
...
##  <a name="a-namebkmklangnonlocalizea-configuration-manager-objects-that-are-not-localized"></a><a name="BKMK_LangNonLocalize"></a>未本地化的 Configuration Manager 对象  

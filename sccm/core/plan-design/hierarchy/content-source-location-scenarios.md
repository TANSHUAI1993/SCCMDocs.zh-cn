...
>
> **如果站点运行版本 1610 或更高版本**，请使用[为 System Center Configuration Manager 定义站点边界和边界组](/sccm/core/servers/deploy/configure/define-site-boundaries-and-boundary-groups)中的信息，了解客户端如何查找包含可用内容的分发点。

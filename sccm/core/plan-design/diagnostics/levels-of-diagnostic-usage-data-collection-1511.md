---
title: "1511 的诊断数据 | System Center Configuration Manager"
...
System Center Configuration Manager 版本 1511 收集三个级别的诊断和使用情况数据：**基本**、**增强**和**完全**。 默认情况下，此功能设置为增强级别。 以下部分提供在每个级别收集哪些数据的其他详细信息。  

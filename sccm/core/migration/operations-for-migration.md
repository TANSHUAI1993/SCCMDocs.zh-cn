...
#### <a name="to-create-a-migration-job-to-migrate-by-collections"></a>创建迁移作业以按集合进行迁移  
...
#### <a name="to-create-a-migration-job-to-migrate-changed-objects"></a>创建迁移作业以迁移更改的对象  

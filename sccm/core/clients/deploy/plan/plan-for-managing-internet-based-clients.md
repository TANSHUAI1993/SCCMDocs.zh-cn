---
title: "基于 Internet 的客户端 |System Center Configuration Manager"
...
---
# <a name="plan-for-managing-internet-based-clients-in-system-center-configuration-manager"></a>System Center Configuration Manager 中的客户端管理计划

*适用范围：System Center Configuration Manager (Current Branch)*

通过基于 Internet 的客户端管理，可在 System Center Configuration Manager 客户端未连接到公司网络但具有标准 Internet 连接时管理该客户端。 这种管理方式有一些优点，例如，不必运行虚拟专用网 (VPN)，从而可以降价成本，以及能够更及时地部署软件更新。  
...
-   你必须具有支持的公钥基础结构 (PKI)，此结构可以部署和管理客户端需要且在 Internet 和基于 Internet 的站点系统服务器上受管理的证书。  
     ...
     有关 PKI 证书的详细信息，请参阅 [System Center Configuration Manager 的 PKI 证书要求](../../../../core/plan-design/network/pki-certificate-requirements.md)。  

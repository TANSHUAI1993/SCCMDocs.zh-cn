...
#### <a name="bkmk_sha2"></a> SHA-2 代码签名支持
...
>
> 如果仍在使用应用程序目录网站用户体验，则客户端需要 Microsoft Silverlight 5.1.41212.0。 自 Configuration Manager 1802 起，客户端不再自动安装 Silverlight。 应用程序目录的主要功能现在包含在软件中心内。<!--1356195-->

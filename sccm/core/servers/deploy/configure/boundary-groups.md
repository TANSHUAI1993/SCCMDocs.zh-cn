...
<!--1356193--> 从版本 1806 开始，边界组包含其他设置，可以让你更好地控制环境中的内容分发。 有关详细信息，请参阅[配置边界组](#bkmk_config)。
...
- 回退时间(以分钟为单位)：此选项设置为 120 分钟。 不能对其进行配置。  
...
<!--1356193--> 从版本 1806 开始，若要为此边界组中的客户端配置其他选项，请切换到“选项”选项卡。有关详细信息，请参阅[对等下载适用的边界组选项](#bkmk_bgoptions)。

...
使用 System Center Configuration Manager 的 Current Branch 时，可安装版本 1802 的控制台内部更新，从之前的版本更新层次结构。 <!-- baseline only statement: -->（由于版本 1802 也可用作[基线介质](/sccm/core/servers/manage/updates#bkmk_Baselines)，因此，可使用该安装介质安装新层次结构的第一个站点。）

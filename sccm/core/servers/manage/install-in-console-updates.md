...
- [审批每台设备的用户的应用程序请求](/sccm/apps/deploy-use/deploy-applications#bkmk_deploy-settings) <!--1357015-->  
- [支持适用于 iOS 的 Cisco AnyConnect 4.0.07x 及更高版本](/sccm/mdm/deploy-use/create-vpn-profiles)<!--1357393-->
...
- [运行任务序列步骤](/sccm/osd/understand/task-sequence-steps#child-task-sequence) <!--1261338-->

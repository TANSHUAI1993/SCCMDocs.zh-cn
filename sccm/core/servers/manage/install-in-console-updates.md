...
- 在“脱机模式”下，服务连接点不会连接到 Microsoft 云服务  。 要下载并导入可用更新，请[使用服务连接工具](/sccm/core/servers/manage/use-the-service-connection-tool)。  

> [!NOTE]  
> 必要时，可将带外修复程序导入到控制台。 为此，请使用[更新注册工具](/sccm/core/servers/manage/use-the-update-registration-tool-to-import-hotfixes)。 这些带外修复程序对你在与 Microsoft 云服务同步时获取的更新进行了补充。  
...
- 该站点使用服务连接点上载有关你的站点的使用情况信息。 此信息可帮助 Microsoft 云服务标识你基础结构的当前版本可用的更新。 有关详细信息，请参阅[诊断和使用情况数据](/sccm/core/plan-design/diagnostics/diagnostics-and-usage-data)。  

- 该站点使用服务连接点通过 Microsoft Intune 和 Configuration Manager 本地移动设备管理来管理设备。 有关详细信息，请参阅[混合移动设备管理 (MDM)](/sccm/mdm/understand/hybrid-mobile-device-management)。  
...
- [用于安装更新 1906 的清单](/sccm/core/servers/manage/checklist-for-installing-update-1906)  

- [用于安装更新 1902 的清单](/sccm/core/servers/manage/checklist-for-installing-update-1902)
...
- 管理中心站点完成更新安装之后，子主站点会自动启动更新。 这是建议的默认流程。 若要控制主站点安装更新的时间，请使用[站点服务器的服务时段](/sccm/core/servers/manage/service-windows)。  
...
> [!TIP]  
> 安装 Configuration Manager 更新时，站点还会更新 CD.Latest 文件夹。 有关详细信息，请参阅 [CD.Latest 文件夹](/sccm/core/servers/manage/the-cd.latest-folder)。  
...
- 在层次结构中的所有站点均更新为新版本之前，你的层次结构会在混合版本模式下运行。 有关详细信息，请参阅[不同版本之间的互操作性](/sccm/core/plan-design/hierarchy/interoperability-between-different-versions)。  
...
在控制台更新完成之后，验证控制台和站点版本是否正确。 转至控制台左上角的“关于 System Center Configuration Manager”  。  
...
> [!TIP]  
> 如果更新存在下载或复制问题，请使用[更新重置工具](/sccm/core/servers/manage/update-reset-tool)。  
...
- [版本 1906 的更新后清单](/sccm/core/servers/manage/checklist-for-installing-update-1906#post-update-checklist)  
...
- [将集合成员身份结果同步到 Azure Active Directory](/sccm/core/clients/manage/collections/create-collections#bkmk_aadcollsync) <!--3607475,C2127144-C8DE-49F6-9CB3-D4F5B59F9515-->
- [Azure Active Directory 用户组发现](/sccm/core/servers/deploy/configure/configure-discovery-methods#bkmk_azuregroupdisco) <!--3611956,023715E7-BFBA-4E9E-A80F-B5B626464ADD-->
- [应用程序组](/sccm/apps/deploy-use/create-app-groups) <!--3555907,EE16A1D8-EF1B-4094-845F-AC107E7C621D-->
- [任务序列调试器](/sccm/osd/deploy-use/debug-task-sequence) <!--3612274,C3F37661-69E4-4D53-A39C-5D02F97E0E71-->
- [包转换管理器](/sccm/apps/pcm/package-conversion-manager) <!--1357861,4E0C09AF-7FC1-4412-A8BB-166D9BCD0093-->
- [适用于共同管理设备的客户端应用](/sccm/comanage/workloads#client-apps) <!--1357892,CC3AE625-BF72-49B1-8AB1-AF0DCF2D6F4C-->
- [第三方软件更新](/sccm/sum/deploy-use/third-party-software-updates)<!--1357605,1352101,1358714;B5E192AE-C81F-4348-9EF9-07A3C0FBE597-->
- [审批每台设备的用户的应用程序请求](/sccm/apps/deploy-use/deploy-applications#bkmk_deploy-settings) <!--1357015,4BA987C9-08FC-48E2-BFFE-C9DCF35B496A-->  
- [支持适用于 iOS 的 Cisco AnyConnect 4.0.07x 及更高版本](/sccm/mdm/deploy-use/create-vpn-profiles)<!--1357393,A421682F-C1A5-4933-A329-3EF35737E52A-->
- [用于条件访问的符合性策略的设备运行状况证明评估](/sccm/mdm/deploy-use/manage-access-to-o365-services-for-pcs-managed-by-sccm) <!--1235616,0E986DC1-D20A-4386-9EB5-108D9D5118EB-->
- [创建和运行脚本](/sccm/apps/deploy-use/create-deploy-scripts) <!--1236459,566F8720-F415-4E10-9A51-CDE682BA2B2E-->
- [运行任务序列步骤](/sccm/osd/understand/task-sequence-steps#child-task-sequence) <!--1261338,3CFFE6AC-D46F-47F0-AD25-19F6EEF21F28-->
- [任务序列内容预缓存](/sccm/osd/deploy-use/configure-precache-content) <!--1021244,1C6BD2E9-C8DB-4DEE-A937-AA84B38957A7-->
- [Surface 驱动程序更新](/sccm/sum/get-started/configure-classifications-and-products) <!--1098490,82AD973A-7CDF-4B67-A665-72875D6E099A-->
- [云管理网关](/sccm/core/clients/manage/cmg/plan-cloud-management-gateway) <!--1101764,DD043119-789C-4158-AC79-725E999F385A-->
- [数据仓库服务点](/sccm/core/servers/manage/data-warehouse) <!--1277922,0EAC8088-6895-440F-B871-11E3C305CFCD-->
- [客户端对等缓存](/sccm/core/plan-design/hierarchy/client-peer-cache) <!--1101436,4C5F2976-7999-4E0C-BAF2-DEB793AD540E-->
- [PFX 创建](/sccm/protect/deploy-use/introduction-to-certificate-profiles) <!--1321368,CED76B79-929C-4C45-981F-B9BCA6D38A17-->
- [Azure Log Analytics 连接器](/sccm/core/clients/manage/sync-data-log-analytics) <!--1258052,73A7EC4D-EF22-4EA4-82A9-419C2A8CFC4D-->
- [Windows Defender 攻击防护策略](/sccm/protect/deploy-use/create-deploy-exploit-guard-policy) <!--1355468,8491D4C8-8484-46B8-BCD6-17DC2CADBAEB-->
- [适用于 Windows 10 的 VPN](/sccm/protect/deploy-use/vpn-profiles) <!--1283610,EDBEBA3D-3A4D-4465-84D9-D71EB811E7F6-->
- [维护群集感知集合（服务器组）](/sccm/sum/deploy-use/service-a-server-group) <!--1081776,290B66D8-C735-4895-B59A-DD732D84A697-->
- [Windows Hello 企业版](/sccm/protect/deploy-use/windows-hello-for-business-settings)（以前称为 Passport for Work）  <!--1245704,8BCA2642-3719-4862-A355-9D39C979E1B4-->
- [托管电脑的条件访问](/sccm/mdm/deploy-use/manage-access-to-o365-services-for-pcs-managed-by-sccm)  <!--1191496,1CD5B9FC-022E-4A78-89F5-DEA58B6F5050-->
...
Current Branch 包含预发行功能，用于生产环境中的早期测试。 有关详细信息，请参阅[预发行功能](/sccm/core/servers/manage/pre-release-features)。

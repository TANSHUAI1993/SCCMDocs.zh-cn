...
|将 App-V 5 连接组迁移到 Configuration Manager 虚拟环境。|请参阅本主题中的[将 App-V 5 连接组迁移到 Configuration Manager 虚拟环境](/sccm/apps/get-started/deploying-app-v-virtual-applications#migrating-app-v-5-connection-groups-to-configuration-manager-virtual-environments)部分。|  

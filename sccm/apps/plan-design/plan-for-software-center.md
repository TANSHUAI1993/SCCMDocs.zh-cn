...
ms.locfileid: "65106516"
---
# <a name="plan-for-software-center"></a>规划软件中心

*适用范围：System Center Configuration Manager (Current Branch)*

用户从软件中心更改设置、浏览和安装应用程序。 在 Windows 设备上安装 Configuration Manager 客户端时，它还会自动安装软件中心。 新软件中心将呈现新式外观。 并且本应仅出现在依赖于 Silverlight 的应用程序目录中的应用（用户可用的应用）现在将出现在“应用程序”选项卡下的软件中心。
